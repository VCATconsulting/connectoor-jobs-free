...
More Power with the [Pro](https://www.connectoor.com/wordpress-plugin "visit the Connectoor Website") Version:
...
1. Job listing backend
2. Possible styling
3. Job Posttype backend
4. Possible job posting frontend
5. Job category list
6. Job employment type list
6. Blocktemplate
8. Upgrade banner
...
* fix crit error for current screen initialization

= 1.2.6 =

* fix crit error on some display cases
...
* fix some phpcs issues
* fix rewrite manual jobs display
* fix search when jobs listed by categories
* remove using load_plugin_textdomain()

= 1.1.0 =

* fix issue that search field is missing after search a job
* move search input outside the loop
* add setting sanitation
* add image to background settings
